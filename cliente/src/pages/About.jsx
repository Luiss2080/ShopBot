...
export default function About() {
  return (
    <motion.div 
      ...
      exit={{ opacity: 0, y: -20 }}
      className="pt-12 pb-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 min-h-[70vh] dark:text-slate-300"
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-20">
        <div className="flex flex-col items-center text-center">
          <div className="w-16 h-16 bg-brand-50 dark:bg-brand-500/10 text-brand-600 dark:text-brand-400 rounded-full flex items-center justify-center mb-6">
            <Bot size={32} />
          </div>
          <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-4">IA Avanzada</h3>
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-4">Arquitectura Moderna</h3>
          <p className="text-slate-500 dark:text-slate-400">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-4">Misión</h3>
          <p className="text-slate-500 dark:text-slate-400">
      ...
      <div className="bg-slate-50 dark:bg-slate-800/50 rounded-3xl p-8 md:p-12 text-center border border-slate-100 dark:border-slate-800">
        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">Únete a la revolución</h2>
        ...
        <button className="bg-slate-900 dark:bg-brand-500 text-white px-8 py-3 rounded-xl font-bold hover:bg-brand-600 transition-colors">
